...
enum eConfigUInt32Values
{
	...
	// Playerbot mod
	CONFIG_UINT32_PLAYERBOT_MAX_NUM_BOTS,		//PlayerbotAI.MaxNumBots = 9
	CONFIG_UINT32_PLAYERBOT_RESTRICT_BOT_LEVEL,	//PlayerbotAI.RestrictBotLevel = 60
	CONFIG_UINT32_PLAYERBOT_BOTGUY_COST,		//PlayerbotAI.BotguyCost = 0
	// End playerbot mod
...
enum eConfigFloatValues
{
	...
	// Playerbot mod
	CONFIG_FLOAT_PLAYERBOT_FOLLOW_DISTANCE_MIN,	//PlayerbotAI.FollowDistanceMin = 0.5
	CONFIG_FLOAT_PLAYERBOT_FOLLOW_DISTANCE_MAX,	//PlayerbotAI.FollowDistanceMax = 1.0
	// End playerbot mod
...
enum eConfigBoolValues
{
	...
	// Playerbot mod
	CONFIG_BOOL_PLAYERBOT_ENABLE_BOTS,			//PlayerbotAI.DisableBots = 1
	CONFIG_BOOL_PLAYERBOT_DEBUG_WHISPER,		//PlayerbotAI.DebugWhisper = 0
	CONFIG_BOOL_PLAYERBOT_COLLECT_COMBAT,		//PlayerbotAI.Collect.Combat = 1
	CONFIG_BOOL_PLAYERBOT_COLLECT_QUEST,		//PlayerbotAI.Collect.Quest = 1
	CONFIG_BOOL_PLAYERBOT_COLLECT_PROFESSION,	//PlayerbotAI.Collect.Profession = 1
	CONFIG_BOOL_PLAYERBOT_COLLECT_LOOT,			//PlayerbotAI.Collect.Loot = 1
	CONFIG_BOOL_PLAYERBOT_COLLECT_SKIN,			//PlayerbotAI.Collect.Skin = 1
	CONFIG_BOOL_PLAYERBOT_COLLECT_OBJECTS,		//PlayerbotAI.Collect.Objects = 1
	CONFIG_BOOL_PLAYERBOT_SELL_GARBAGE,			//PlayerbotAI.SellGarbage = 0
	// End playerbot mod
